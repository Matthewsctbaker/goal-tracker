// Reference content for the "Operating System" tab (full reference, multiple
// questions per section) plus a single distilled `question` per section used by
// the fillable "Who am I?" questionnaire.
window.OS_CONTENT = {
